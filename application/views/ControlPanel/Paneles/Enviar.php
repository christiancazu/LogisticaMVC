<div class="container tab-pane" id="enviar">
    <div class="row">
        <div class="col-sm-6 col-md-6 col-md-offset-3">
            <div class="panel bg-blanco">
                <form class="form" action="<?= base_url()?>ControlPanel/EnviarExpediente" method="post">
                    <div class="panel-head bg-azul">
                        <h4 class="text-center text-blanco">Envio de Expediente</h4>
                    </div>
